...
if ($_SERVER['REQUEST_METHOD'] === "POST") {
    ...
    if ($error) {
        header("Location: /client/create-address.php?" . http_build_query($_POST + ['error' => $error]));
        die();
    }

    $stmt = $db->prepare("INSERT INTO addresses (user_id, name, phone, line, zip_code, city) VALUES (:user_id, :name, :phone, :line, :zip_code, :city)");
    $stmt->execute([
        'name' => $_POST['name'],
        'phone' => $_POST['phone'],
        'line' => $_POST['line'],
